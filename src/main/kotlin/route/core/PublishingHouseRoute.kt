...
object PublishingHouseRoute : BaseEntryRoute<PublishingHouse, PublishingHouseResponse>() {
    ...
    override suspend fun getResponseSpecialHandling(obj: PublishingHouse): PublishingHouseResponse {
        return PublishingHouseResponse(obj)
    }
